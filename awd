...
CreditLabel.Text = "Tiktok: @itss_hiroshi"
CreditLabel.Font = Enum.Font.GothamBold
CreditLabel.TextSize = 15
CreditLabel.TextColor3 = Color3.fromRGB(180, 180, 180)
CreditLabel.BackgroundTransparency = 1
CreditLabel.Size = UDim2.new(1, 0, 0, 20)
CreditLabel.Position = UDim2.new(0, 0, 1, -44)
CreditLabel.TextXAlignment = Enum.TextXAlignment.Center
CreditLabel.Parent = MainFrame

--// Credit
local TikTokBtn = Instance.new("TextButton")
TikTokBtn.Text = "Copy Link"
TikTokBtn.Font = Enum.Font.GothamBold
TikTokBtn.TextSize = 15
TikTokBtn.TextColor3 = Color3.fromRGB(180, 180, 180)
TikTokBtn.BackgroundTransparency = 1
TikTokBtn.Size = UDim2.new(1, 0, 0, 20)
TikTokBtn.Position = UDim2.new(0, 0, 1, -25)
TikTokBtn.TextXAlignment = Enum.TextXAlignment.Center
TikTokBtn.Parent = MainFrame

TikTokBtn.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://www.tiktok.com/@itss_hiroshi")
        game.StarterGui:SetCore("SendNotification", {
            Title = "TikTok Link",
        ...
        game.StarterGui:SetCore("SendNotification", {
            Title = "TikTok Link",
            Text = "https://www.tiktok.com/@itss_hiroshi",
            Duration = 3
        })
    end
end)
